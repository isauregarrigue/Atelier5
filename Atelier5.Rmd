...
```{r}
# Utiliser pour repondre à la quistion 1
...
```{r}
# Utiliser pour repondre à la guestion 2
enfants <-imcenfant$SEXE[imcenfant$IMC < 15 & imcenfant$age <= 3.5]
table(enfants)
```

Commentaire: Il y a 4 filles qui ont un IMC inferieur à 15 et qui ont un âge supérieur ou égal à 3 ans et demi. Il y a 4 garçons qui ont un IMC inférieur à 15 et qui ont un âge supérieur ou égal à 3 ans et demi.
...
Commentaire: Au total, 8 enfants ont un IMC inférieur à 15 et qui ont un âge supérieur ou égal à 3 ans et demi.
...
```
 ...
 Commentaire: Parmi les enfants qui ont un IMC inférieur à 15 et qui ont un âge supérieur ou égal à 3 ans et demi, 3 ne sont pas située en zone d’éducation prioritaire.
...
différence
```
La différence entre la médiane et la moyenne est très petite : 0,02117762, on peut supposer que la médiane est égale à la moyenne.
...
length(imcenfant$taille[imcenfant$SEXE=="F" & imcenfant$zep=="O"])/length(imcenfant$taille[imcenfant$SEXE=="F"])
proba
```
Commentaire : La probalibilé de trouver une fille dans dans une école située en zone d’éducation prioritaire est 'r proba' 
